...
export default function DifferentMonthsComparison_uk({ familyId }: Props) {
  ...
  if (monthOne && monthTwo) {
    ...
    caption = `Порівняння ${month1Str} і ${month2Str}`;
  }
      ...
      >
        <div className="flex items-center justify-center gap-2">
          <div className="flex flex-col items-center">
            <label htmlFor="month-1">Місяць 1</label>
            <Input
              type="month"
              pattern="\d{4}-\d{2}"
              placeholder="YYYY-MM"
          ...
          <div className="flex flex-col items-center">
            <label htmlFor="month-1">Місяць 2</label>
            <Input
              type="month"
              pattern="\d{4}-\d{2}"
              placeholder="YYYY-MM"
        ...
        <Button className="w-[95%]">Встановити</Button>
      </form>
