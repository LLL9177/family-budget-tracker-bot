...
import EarnerCategoryLeaderboard_uk from "./earnerCategoryLeaderboard";
import EarnerLeaderboard_uk from "./earnerLeaderboard";
import DifferentMonthsComparison_uk from "./differentMonthsComparison";
import FamilyId_uk from "./familyId";
import SpenderLeaderboard_uk from "./spenderLeaderboard";
import SpenderCategoryLeaderboard_uk from "./spenderCategoryLeaderboard";
import { SectionCards_uk } from "./sectionCards";
import MonthComparison_uk from "./monthComparison";
  ...
  useEffect(() => {
    const getProfile = async function () {
      try {
        ...
        if (data.message) {
          if (data.statusCode == 401) navigate("/uk/login");
        }
        ...
        <div className="flex-col h-full w-[100vw] items-center justify-center gap-3">
          <div className="flex h-full w-[100vw] items-center justify-center gap-3">
            <div className="h-[100vh] w-125">
              ...
              />
              <DifferentMonthsComparison_uk familyId={familyId} />
              <FamilyId_uk familyId={familyId} />
            </div>
          ...
          <div className="flex items-center justify-center gap-5">
            <SpenderLeaderboard_uk topSpenders={topSpenders} />
            <EarnerLeaderboard_uk topEarners={topEarners} />
            <EarnerCategoryLeaderboard_uk topEarnerCategories={topEarnedFrom} />
            <SpenderCategoryLeaderboard_uk topSpenderCategories={topSpentOn} />
          </div>
        </div>
      )}
    </div>
