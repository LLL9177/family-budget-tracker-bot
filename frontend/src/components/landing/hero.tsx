...
export default function Hero({ lang }: Props) {
  ...
  return (
    <header className="shadow-[rgb(0,0,0)]-200 flex h-screen w-screen flex-col gap-8 bg-gradient-to-b to-[rgba(113,132,193,0.2)] p-8 px-50 backdrop-blur-xl md:flex-row md:items-center md:justify-between dark:to-[rgba(34,45,80,0.5)]">
