...
const i18n = {
  en: {
    title: "Telegram Login Requests",
    description:
      "These are requests sent from the bot when someone tries to log in to your account using the bot.",
    noRequestsTitle: "No requests",
    noRequestsDescription:
      "You will see them when somebody tries to log in to your account in the bot",
  },

  uk: {
    title: "Запити входу через Telegram",
    description:
      "Це запити, які надходять від бота, коли хтось намагається увійти у ваш акаунт через бота.",
    noRequestsTitle: "Немає запитів",
    noRequestsDescription:
      "Вони з’являться, коли хтось спробує увійти у ваш акаунт через бота",
    accept: "Прийняти",
    deny: "Відхилити",
  },
};

export default function TelegramRequests({ hide }: Props) {
          ...
          >
            {requests && requests.length > 0 ? (
              ...
              <Card className="flex lg:w-150 w-[90vw] items-center justify-center overflow-y-scroll rounded-3xl p-5 shadow-[0_0_40px_0_rgba(255,255,255,0.3)] select-none dark:shadow-[0_0_40px_0_rgba(255,255,255,0.08)]">
                <h1 className="text-3xl">{t.noRequestsTitle}</h1>
