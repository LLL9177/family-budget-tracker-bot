      ...
      <div className="min-h-screen bg-gradient-to-b from-zinc-950 via-zinc-900 to-black text-white">
        <div className="mx-auto max-w-4xl px-6 py-12">
            ...
            <div className="px-8 pb-8">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <code
                    className="block cursor-pointer rounded-xl bg-muted p-2 text-xs text-black select-none dark:text-white"
                    onClick={() => copyUserId()}
                  >
                    {user?.id}
                  </code>
              ...
              <p className="mt-2 text-zinc-400">
                {t.memberOf} {user?.family?.name ?? "No Family"}
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h2 className="mb-2 text-sm text-zinc-400">{t.email}</h2>
              <p>{user?.email}</p>
            </div>
        ...
        {transactions && (
          <div className="mx-auto mt-8 max-w-4xl rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            <h2 className="mb-6 text-xl font-semibold">{t.transactions}</h2>
